      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 md:gap-8 lg:gap-8 xl:gap-12">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            {/* Social Media Links using inline SVGs to guarantee compatibility */}
            <div className="flex gap-3">
              {/* Facebook */}
              <Link href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-slate-900 border border-slate-800/80 hover:border-primary/50 hover:bg-primary/10 text-slate-400 hover:text-primary rounded-xl transition-all duration-300 shadow-sm hover:shadow-[0_0_10px_rgba(0,158,227,0.15)]">
              ...
              {/* Twitter/X */}
              <Link href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-slate-900 border border-slate-800/80 hover:border-primary/50 hover:bg-primary/10 text-slate-400 hover:text-primary rounded-xl transition-all duration-300 shadow-sm hover:shadow-[0_0_10px_rgba(0,158,227,0.15)]">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Instagram */}
              <Link href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-slate-900 border border-slate-800/80 hover:border-primary/50 hover:bg-primary/10 text-slate-400 hover:text-primary rounded-xl transition-all duration-300 shadow-sm hover:shadow-[0_0_10px_rgba(0,158,227,0.15)]">
              ...
              {/* YouTube */}
              <Link href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-slate-900 border border-slate-800/80 hover:border-primary/50 hover:bg-primary/10 text-slate-400 hover:text-primary rounded-xl transition-all duration-300 shadow-sm hover:shadow-[0_0_10px_rgba(0,158,227,0.15)]">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* GitHub */}
              <Link href="https://github.com" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-slate-900 border border-slate-800/80 hover:border-primary/50 hover:bg-primary/10 text-slate-400 hover:text-primary rounded-xl transition-all duration-300 shadow-sm hover:shadow-[0_0_10px_rgba(0,158,227,0.15)]">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
